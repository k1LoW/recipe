...
$ingredients = array(
    ...
    'migrations' => array(
        ...
        'author' => 'Cake Development Corporation',
        'type' => RECIPE_TYPE_PLUGIN,
        'url' => 'https://github.com/CakeDC/migrations/tarball/master',
        'archive' => RECIPE_ARCHIVE_TARBALL,
    ...
    'cakektailibrary' => array(
        'name' => 'CakeKtaiLibrary',
    ...
    'debugkitshortcut' => array(
        'name' => 'DebugKitShortcut',
    ...
    'yav' => array(
        'name' => 'Yav',
        'description' => 'Yer Another Validation Set for CakePHP',
        'author' => 'k1LoW',
        'type' => RECIPE_TYPE_PLUGIN,
        'url' => 'https://github.com/k1LoW/Yav/tarball/master',
        'archive' => RECIPE_ARCHIVE_TARBALL,
